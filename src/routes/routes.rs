...
use crate::handler::{
    ...
    products_handler::{
        create_product_handler, get_product_by_id_hanlder, get_product_by_sku_handler,
        get_product_by_slug_handler, getall_products_handler,
    },
};
...
pub fn routes(state: AppState) -> Router {
    Router::new()
        .route(
            "/api/v1/products",
            get(getall_products_handler).post(create_product_handler),
        )
        ...
        .route(
            ...
            get(get_product_by_sku_handler),
        )
        .with_state(state)
}
